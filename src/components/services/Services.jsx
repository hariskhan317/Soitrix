    ...
    return (
        <div id="services" className="md:pb-50 px-8 md:px-20 lg:px-52 2xl:max-w-[100rem] mx-auto">
            <div className="text-center md:text-left">
                ...
                <p className="mt-3 text-base md:text-xl text-brand-gray">At Soitrix, we offer a comprehensive range of services to meet all<br className='hidden md:block' /> your Development needs</p>
            </div>
            {/* card */}
