            ...
            <div className='fixed w-full bg-brand-black z-50 pr-12 shadow-xl'> 
                <div className='flex justify-between'>
                    ...
                    <ul className='hidden md:flex gap-14 pt-6 '>
                        ...
                        <li className='cursor-pointer text-white font-medium text-lg' onClick={() => handleScroll('contact')}>Contact Us</li>
                    </ul>
                    <RxHamburgerMenu onClick={() => setShowBar(!showBar)} className='cursor-pointer block md:hidden text-white text-4xl mt-5' />
                </div>
                {showBar && (<ul className='block md:hidden py-6 space-y-7 mt-6 h-screen'>
                    <li className='px-14 cursor-pointer text-white text-xl font-medium' onClick={() => handleScroll('home')}>Home</li> 
                    <li className='px-14 cursor-pointer text-white text-xl font-medium' onClick={() => handleScroll('services')}>Services</li>
                    <li className='px-14 cursor-pointer text-white text-xl font-medium' onClick={() => handleScroll('testimonials')}>Testimonials</li>
                    <li className='px-14 cursor-pointer text-white text-xl font-medium' onClick={() => handleScroll('contact')}>Contact Us</li>
