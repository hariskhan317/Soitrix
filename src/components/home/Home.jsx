    ...
    <div id="home" className="relative 2xl:max-w-[100rem] mx-auto z-40">
        ...
        <div className="relative text-center pt-40 md:pb-56 px-8 md:px-20 lg:px-52 z-50">
          ...
          <div className='flex justify-center mt-16'>
            <button onClick={() => handleScroll('contact')} className='bg-brand-gray-100 p-2.5 w-auto flex justify-center gap-10 border-[2px] border-gray-50 rounded-lg'>
              <span className='text-white text-2xl mt-2'>Get a Quote</span>
              <div className='bg-gray-100 rounded-lg h-12 w-14 flex justify-center'>
